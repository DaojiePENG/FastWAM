...
class LeRobotDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        # Check timestamps
        # datasets>=4 exposes a Column sequence rather than a literal list;
        # torch.stack intentionally requires a concrete tuple/list.
    ...
    def get_episode_data(self, episode_id: int) -> dict:
        ...
        res = {key: torch.stack(list(selected_data[key])) for key in res_keys}
        return res
